...
from Parsing.scripts.Hotelbeds import ParserConfigHotelopiaPython
...
ParserBase.CONFIG_FILE = ParserConfigHotelopiaPython
...
class RoomType(ParserBase):
    ...
    def parsed__room_types(self):
        ...
        for container in containers:
            roomtype = str(container.xpath(ParserConfigHotelopiaPython.RoomType__type)[0]).strip()
            room_code = str(container.xpath(ParserBase.CONFIG_FILE.Hotel__roomCode)[0]).strip()
            priceblocks = container.xpath(ParserConfigHotelopiaPython.RoomType__priceblocks)
            for priceblock in priceblocks:
                price = priceblock.xpath(ParserConfigHotelopiaPython.RoomType__price)[0]
                # try:
                #     promotionDesc = priceblock.xpath(ParserConfigHotelopiaPython.RoomType__promotion)[0]
                #     promocode = priceblock.xpath(ParserConfigHotelopiaPython.RoomType__promotioncode)[0]
                #     promotion ='Y'
                #
                # except:
                #     promotionDesc=''
                ...
                boardtype = str(priceblock.xpath(ParserConfigHotelopiaPython.RoomType__boardType)[0]).strip()
