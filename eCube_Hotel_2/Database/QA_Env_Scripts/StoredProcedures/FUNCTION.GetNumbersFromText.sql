...
CREATE FUNCTION `GetNumbersFromText`(p_string VARCHAR(1000)) RETURNS varchar(100) CHARSET utf8
BEGIN
/*******************************************************************         
'	Name					: GetNumbersFromText
'	Desc					: To get Number from given string
'	Called by				: sp: sp_GetReportUploadUpdate
'	Example of execution	: select GetNumbersFromText('qq4rr.tt5l');
INPUT PARAMETRS		 	 
	Data NVARCHAR(512)
Retruns 
	varchar(512) CHARSET utf8
'	Created by				: Bhavin.Dhimmar
'	Date of creation		: 18-Jun-2018
