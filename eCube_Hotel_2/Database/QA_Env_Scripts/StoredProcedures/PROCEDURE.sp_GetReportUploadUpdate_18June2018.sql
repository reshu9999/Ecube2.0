...
CREATE PROCEDURE `sp_GetReportUploadUpdate_18June2018`(
	p_RequestId INT,
	p_RequestRunId INT,
...
BEGIN
	...
	Select  p_RequestId,v_nvcrBatchName,CONCAT('Missing Date: ' , Date_format(sdtmBatchDateCrawl, 106)), 170  
		 from LastResultQACheck BCD 
		   Right Join 
	(Select sdtmBatchDateCrawl, intBatchId From tbl_HotelRequestsDateDetails  Where intBatchId = p_RequestId) BD
