...
--
-- Table structure for table `tbl_HotelCrawlRequestDetail`
--

DROP TABLE IF EXISTS `tbl_HotelCrawlRequestDetail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_HotelCrawlRequestDetail` (
  `HotelCrawlRequestDetailId` bigint(20) NOT NULL AUTO_INCREMENT,
  `RequestId` int(11) NOT NULL,
  `RequestRunId` int(11) NOT NULL,
  `HotelReqestInputDetailsId` bigint(20) NOT NULL,
  ...
  PRIMARY KEY (`HotelCrawlRequestDetailId`),
  KEY `RequestId` (`RequestId`),
  KEY `RequestRunId` (`RequestRunId`),
  KEY `StatusId` (`StatusId`),
  CONSTRAINT `tbl_HotelCRDetail_tbl_RequestMaster_RequestId` FOREIGN KEY (`RequestId`) REFERENCES `tbl_RequestMaster` (`RequestId`),
  CONSTRAINT `tbl_HotelCRDetail_tbl_RequestRunDetail_RequestRunId` FOREIGN KEY (`RequestRunId`) REFERENCES `tbl_RequestRunDetail` (`RequestRunId`),
  CONSTRAINT `tbl_HotelCRDetail_tbl_StatusMaster_StatusId` FOREIGN KEY (`StatusId`) REFERENCES `tbl_StatusMaster` (`StatusId`)
...
-- Dump completed on 2018-06-29 15:15:22
