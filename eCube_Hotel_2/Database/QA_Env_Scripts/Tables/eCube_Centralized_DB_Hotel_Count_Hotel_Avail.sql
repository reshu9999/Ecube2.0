...
--
-- Table structure for table `Hotel_Count_Hotel_Avail`
--

DROP TABLE IF EXISTS `Hotel_Count_Hotel_Avail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Hotel_Count_Hotel_Avail` (
...
-- Dump completed on 2018-06-29 15:22:04
