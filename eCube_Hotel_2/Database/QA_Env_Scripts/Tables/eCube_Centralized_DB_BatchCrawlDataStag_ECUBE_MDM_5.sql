...
--
-- Table structure for table `BatchCrawlDataStag_ECUBE_MDM_5`
--

DROP TABLE IF EXISTS `BatchCrawlDataStag_ECUBE_MDM_5`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BatchCrawlDataStag_ECUBE_MDM_5` (
  ...
  `intBatchCrawlStagId` int(11) NOT NULL,
  `BatchCrawlDataStag` int(11) DEFAULT NULL,
  ...
  `nvcrCost` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `nvcrCostCurrency` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `nvcrTaxIncluded` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `nvcrIncluded1` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `nvcrTAXNotIncluded` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `nvcrNotIncluded1` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `nvcrTAX$Included` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `nvcrCurrencyIncluded` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `nvcrIncluded2` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `nvcrTAX$NotIncluded` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `nvcrCurrencyNotIncluded` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `nvcrNotincluded2` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `nvcrRoomChar` varchar(1000) CHARACTER SET utf8 DEFAULT NULL,
  `nvcrMultipleZoneCheck` varchar(2000) CHARACTER SET utf8 DEFAULT NULL
...
-- Dump completed on 2018-06-29 15:15:40
