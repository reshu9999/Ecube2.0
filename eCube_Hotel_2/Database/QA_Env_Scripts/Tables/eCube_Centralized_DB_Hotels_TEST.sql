...
--
-- Table structure for table `Hotels_TEST`
--

DROP TABLE IF EXISTS `Hotels_TEST`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Hotels_TEST` (
  ...
  PRIMARY KEY (`HotelId`),
  KEY `CityId` (`CityId`),
  KEY `StarRatingId` (`StarRatingId`),
  KEY `DomainId` (`CompetitorId`),
  KEY `RequestId` (`RequestId`),
  KEY `CreatedBy` (`CreatedBy`),
  KEY `ModifiedBy` (`ModifiedBy`),
  KEY `Hotels_HotelStatus_HotelStatusId` (`HotelStatusId`),
  CONSTRAINT `Hotels_Cities_CityId` FOREIGN KEY (`CityId`) REFERENCES `Cities` (`CityId`),
  CONSTRAINT `Hotels_HotelStatus_HotelStatusId` FOREIGN KEY (`HotelStatusId`) REFERENCES `HotelStatus` (`HotelStatusId`),
  CONSTRAINT `Hotels_StarRatings_StarRatingId` FOREIGN KEY (`StarRatingId`) REFERENCES `StarRatings` (`StarRatingId`),
  CONSTRAINT `Hotels_tbl_CompetitorMaster_CompetitorId` FOREIGN KEY (`CompetitorId`) REFERENCES `tbl_CompetitorMaster` (`CompetitorId`),
  CONSTRAINT `Hotels_tbl_RequestMaster_RequestId` FOREIGN KEY (`RequestId`) REFERENCES `tbl_RequestMaster` (`RequestId`),
  CONSTRAINT `Hotels_tbl_usermaster_CreatedBy` FOREIGN KEY (`CreatedBy`) REFERENCES `tbl_UserMaster` (`UserId`),
  CONSTRAINT `Hotels_tbl_usermaster_ModifiedBy` FOREIGN KEY (`ModifiedBy`) REFERENCES `tbl_UserMaster` (`UserId`)
...
-- Dump completed on 2018-06-29 15:23:17
