...
--
-- Table structure for table `Hotel_Count_Ecube_MDM_5`
--

DROP TABLE IF EXISTS `Hotel_Count_Ecube_MDM_5`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Hotel_Count_Ecube_MDM_5` (
...
-- Dump completed on 2018-06-29 15:06:06
