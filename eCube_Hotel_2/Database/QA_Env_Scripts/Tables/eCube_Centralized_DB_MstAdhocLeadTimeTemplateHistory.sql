...
--
-- Table structure for table `MstAdhocLeadTimeTemplateHistory`
--

DROP TABLE IF EXISTS `MstAdhocLeadTimeTemplateHistory`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `MstAdhocLeadTimeTemplateHistory` (
  `intMstAdhocLeadTimeHistory` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `smdAddToHistoryDate` datetime DEFAULT NULL,
  ...
  UNIQUE KEY `intMstAdhocLeadTimeHistory` (`intMstAdhocLeadTimeHistory`)
...
-- Dump completed on 2018-06-29 15:19:21
