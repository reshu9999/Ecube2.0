...
--
-- Table structure for table `BatchCrawlDatafinal_Hotel_Avail_Last_R_SEC`
--

DROP TABLE IF EXISTS `BatchCrawlDatafinal_Hotel_Avail_Last_R_SEC`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BatchCrawlDatafinal_Hotel_Avail_Last_R_SEC` (
...
) ENGINE=InnoDB AUTO_INCREMENT=276725 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2018-06-29 15:19:50
