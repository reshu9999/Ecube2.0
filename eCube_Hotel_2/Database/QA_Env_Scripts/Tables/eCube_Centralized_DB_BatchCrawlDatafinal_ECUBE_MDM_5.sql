...
--
-- Table structure for table `BatchCrawlDatafinal_ECUBE_MDM_5`
--

DROP TABLE IF EXISTS `BatchCrawlDatafinal_ECUBE_MDM_5`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BatchCrawlDatafinal_ECUBE_MDM_5` (
  ...
  PRIMARY KEY (`intBatchCrawlDataFinalId`),
...
-- Dump completed on 2018-06-29 15:05:43
