...
CREATE TABLE `BatchCrawlData` (
  ...
  KEY `idx_BatchCrawlData_DipbagDynamicId_SupplierId` (`intDiPBagDynamicId`)
) ENGINE=InnoDB AUTO_INCREMENT=520765023 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2018-06-29 15:24:36
