...
--
-- Table structure for table `BatchCrawlDatafinal_ECUBE_MDM_5_TEST`
--

DROP TABLE IF EXISTS `BatchCrawlDatafinal_ECUBE_MDM_5_TEST`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BatchCrawlDatafinal_ECUBE_MDM_5_TEST` (
  ...
  `intBatchCrawlDataFinalId` int(11) NOT NULL,
  ...
  `nvcrMultipleZoneCheck` varchar(2000) DEFAULT NULL,
...
-- Dump completed on 2018-06-29 15:11:30
