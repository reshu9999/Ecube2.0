...
IF (p_EntryMode > 0) THEN 
	...
	Select RunId Into v_RunId  From  MatchingRunMaster  order by 1 desc limit 1;
...
Alter Table Temp_HotelRelation Add PrimaryHotelAddres   Varchar(4000) Default '';
Alter Table Temp_HotelRelation Add SecondaryHotelAddres Varchar(4000) Default '';
...
On TT.HotelRelationComHotelId = S.HotelId Set 
	TT.PrimaryHotelAddres   = IFNULL(P.MatchHotelAddress1,''),
	TT.SecondaryHotelAddres = IFNULL(S.MatchHotelAddress1,''),
