...
/*=====START: History of duplicate Hotels before delete  =====*/                        
	...
	(CityId Int,CompetitorId Int,WebSiteHotelId varchar(500));
	...
	Insert into TempDuplicateHotels (WebSiteHotelId, CityId, CompetitorId)
    ...
    (
		...
		@rn1 := 
			if(@WebSiteHotelId = A.WebSiteHotelId
				...
				If(@LastAppearnceDate = A.LastAppearnceDate,@rn1,@rn1 +1)
			,  1) As Rank, A.HotelId,
