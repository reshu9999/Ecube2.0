...
CREATE PROCEDURE `spExcelUploadHotelMaster5`(
 p_intSupplierId int,  
 p_intUserId Int 
		 ...
		 -- ---------------------------------Code for new city change city name--------------------------------------------
		  ...
		  INSERT INTO Hotels(  
			 ...
			 SELECT t.Websitehotelcode,  
			  t.Hotelname , -- fn_HotelNameReplaceSpecialChars(t.Hotelname),  
			   t.Address1,  
			   t.Cityid,  
			   t.Starrating,  
			   t.ZipCode, 
		  ...
		  -- ---------------Start update HotelMonitor.msthotel all details--------   
			...
			INNER JOIN  TempHotelMaster T 
			   ...
			   SET H.HotelName = t.Hotelname , -- fn_HotelNameReplaceSpecialChars(Hotelname),  
			   H.HotelAddress1 =Address1 ,  
			   H.CityId = T.Cityid,  
			   H.StarRatingId = Starrating,  
