...
--
-- Table structure for table `MSTHotelCleared`
--

DROP TABLE IF EXISTS `MSTHotelCleared`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `MSTHotelCleared` (
  ...
  `tintHotelMatchStatus` tinyint(4) NOT NULL,
  `nvcrHotelDescription` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `intUsrId` int(11) NOT NULL,
  `bitisProceesed` bit(1) NOT NULL,
  `sdtAddedDateTime` datetime NOT NULL,
  `nvcrmatchhotelname` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `intDipBagSyncId` int(11) DEFAULT NULL,
  `bitIsMailed` bit(1) NOT NULL,
  `nvcrComments` varchar(25) CHARACTER SET utf8 DEFAULT NULL,
  `sdtCommentsDateTime` datetime NOT NULL,
