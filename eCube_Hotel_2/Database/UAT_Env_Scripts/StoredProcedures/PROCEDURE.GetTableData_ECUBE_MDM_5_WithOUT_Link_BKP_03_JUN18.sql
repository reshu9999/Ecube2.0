...
CREATE PROCEDURE `GetTableData_ECUBE_MDM_5_WithOUT_Link_BKP_03_JUN18`( 
	p_intBatchId INT 
 ...
 */
 ...
 CALL sp_GetBatchDataAfterErrorCheck (0,p_intDipBagDynamicId,p_nvcrSupplierID); -- -25756
...
END IF;
 ...
 Values(p_intBatchId,p_intDipBagDynamicId,'Start Last result');
	*/
		...
		CALL sp_LastResult_Report ( p_intDipBagDynamicId,p_intBatchId,p_intSourceMDM_BatchesId);
