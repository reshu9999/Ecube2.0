...
CREATE TABLE `Hotels` (
  ...
  KEY `idx_Hotels_WebSiteHotelId` (`WebSiteHotelId`),
  KEY `idx_Hotels_CompetitorId` (`CompetitorId`),
  KEY `idx_Hotels_WebSiteHotelId_CompetitorId` (`WebSiteHotelId`,`CompetitorId`),
  KEY `nonix_MSTHotel` (`CompetitorId`,`CityId`,`StarRatingId`,`WebSiteHotelId`,`HotelName`)
) ENGINE=InnoDB AUTO_INCREMENT=6796381 DEFAULT CHARSET=latin1;
