...
--
-- Temporary table structure for view `vw_HotelStandardization`
--
...
--
-- Temporary table structure for view `vw_SecondarySupplier_HotelCode`
--
...
--
-- Temporary table structure for view `vw_HotelStandardization_primarysupplier`
--
...
--
-- Temporary table structure for view `view_RequestManagement`
--
...
--
-- Temporary table structure for view `vw_PrimarySupplierHotels`
--
...
--
-- Temporary table structure for view `vw_competitor`
--
...
--
-- Temporary table structure for view `vw_dipbaghm_getcitycountry`
--
...
--
-- Temporary table structure for view `vw_secondarysupplier`
--
...
--
-- Temporary table structure for view `vw_HotelStandardization_GeneralRules`
--
...
-- Dump completed on 2018-06-29 16:00:38
